...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      if (isControlled) {
        ...
        localStorage.setItem("credx-theme", newTheme ? "dark" : "light")
      }
    }
  ...
  return (
    <button
      ...
      {...props}
    >
      <Moon className="size-[18px] transition-transform duration-300 group-hover:-rotate-12 dark:hidden" aria-hidden="true" />
      <Sun className="hidden size-[18px] transition-transform duration-300 group-hover:rotate-45 dark:block" aria-hidden="true" />
